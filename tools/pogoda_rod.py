...
def main():
    ...
    out={"miejsce":"Woźniki","aktualizacja":datetime.datetime.now(datetime.timezone(datetime.timedelta(hours=2))).strftime("%d.%m %H:%M"),"teraz":teraz,"dni":dni[:8],"zrodlo":"Open-Meteo"}
