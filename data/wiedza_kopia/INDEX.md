...
Wygenerowany automatycznie przez `tools/porzadek.py` — 04.08.2026 07:44.
...
|---|---|---|---|
| `BRIEF_DLA_KLAUDKA.md` | 04.08 | 1K | 1. STOP PRODUKCJI: OBOWIĄZUJE (D-0004) | wygenerowano 2026-08-04 09:44:40 CEST |
| `IZABELA_KANON_0.1.md` | 04.08 | 21K | IZABELA — KANON 0.1 (decyzja Tomasza, 29.07.2026) |
...
|---|---|---|---|
| `/root/rod-ai-studio/TELEPORT_fabryka.md` | 136K | 04.08 | teleport fabryki — ARCHIWUM, nie czytac w calosci, szukac przez szukaj.py |
