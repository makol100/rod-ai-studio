...
if prev:
    prompt=("Extend this video: continue the exact same continuous shot without any cut - the same man, the same face, the same voice and tone, "
            ...
            f"lips in sync. He says the line EXACTLY ONCE, clearly and fluently, never repeating any word or phrase, then, after the last word, he smiles warmly and gives a small nod without saying anything more: \"{kw}\" Natural ambient garden sounds continue. No subtitles, no captions, no on-screen text, no logos.")
    ...
    img=base64.b64encode(open("../test1/ref_tomasz_720.jpg","rb").read()).decode()
