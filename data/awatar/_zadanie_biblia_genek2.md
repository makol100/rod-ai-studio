GENEK — wróciłeś ze świeżą pulą. Dekret Tomasza (verbatim, 27.07): "Awatar Stanisława ma być doprecyzowany do końca!!! Nie halucynować wszyscy bo chuja narazie macie!!!!" — dekret drugi: meldunki decyzyjne WYMAGAJĄ Twojego podpisanego głosu; Tomasz wstrzymał decyzje do Twojego powrotu.
ZADANIE (JEDNO zapytanie — oszczędzamy Twoją pulę 20/dzień): zaopiniuj DRAFT BIBLII PANA STANISŁAWA wklejony niżej.
- Pkt 1/2/3/5/7 (dusza postaci: biografia, język, intro/outro, zasady treści, wymowa TTS) — TU jesteś głównym głosem: wybierz wariant LUB daj lepszy własny; dorzuć gotowe sformułowania (powiedzonka, zdania biografii) brzmiące jak prawdziwy ciepły starszy pan ze śląskiej prowincji, zero teatralnej sztampy.
- Pkt 4/6/8/9 (rzemiosło, rekomendacje Zenka: C/C/A/C) — krótko: zgoda albo sprzeciw z jednym zdaniem.
FORMA: numerowana lista 1-9, przy każdym Twój wybór + max 2 zdania; na końcu podpis "— Genek". Po polsku.
=== DRAFT BIBLII ===
