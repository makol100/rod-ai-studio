...
## ZGODNE U WSZYSTKICH
- 6 punktów dekretu = 5 kroków strony /dla-dzialkowcow/ (pkt 3→krok 1-2, pkt 4→3, pkt 5→4, pkt 6→5); pkt 1-2 to STATUS ZARZĄDU (nie zadanie działkowca) — mówi je Tomasz.
...
| wariant | Tomasz (Omni) | Izabela | koszt | czas |
|---|---|---|---|---|
| OSZCZĘDNY (Zenek) | 1 klip: pkt 1 | 1 Kling + głos nad planszami: pkt 2-6 + dodatki | ~1,5 USD | ~100 s |
| DUET (wspólny wniosek) | 3 klipy: pkt 1, pkt 2, pkt 4 | 2 Kling + głos nad planszami: pkt 3, 5, 6 + dodatki | ~4 USD | ~100 s |
| PEŁNY (Henio/Genek) | 4-5 klipów: pkt 1, 2, 4, 6a, 6b | 4-5 Kling | ~6 USD | ~85 s |

## SCENARIUSZ — WARIANT DUET (rekomendacja: obydwoje prowadzą, najniższy koszt pełnego duetu)
| czas | obraz / plansza | kto | kwestia (DOSŁOWNIE do zatwierdzenia) |
|---|---|---|---|
| 0-5 | intro C | — | — |
| 5-15 | Tomasz na tle gotowej alejki, etykieta PREZENTER AI; plansza „1 · KABLE W ZIEMI · DO 2 TYGODNI" | TOMASZ (Omni 1) | „Dzień dobry, tu Tomasz. Kable w górnej alejce są położone i zasypane. Teraz do dwóch tygodni dajemy czas na uleżenie gleby i kabla." |
