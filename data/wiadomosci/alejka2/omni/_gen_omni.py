...
B = "/root/rod-ai-studio/data/wiadomosci/alejka2/omni"
KWESTIE = {
...
tlo = base64.b64encode(open(f"{B}/tlo_alejka_gotowa_720.jpg", "rb").read()).decode()
PROMPT = ("Use the man from <IMAGE_REF_0> as the main character. Keep his exact face: the same eyes, eyebrows, nose, "
 ...
 "Setting: he stands in the exact garden alley shown in <IMAGE_REF_1> - a finished grassy allotment path in Poland, "
 "the soil freshly raked flat after the cable was buried, hedges and fruit trees on both sides, soft overcast daylight; "
 "the background is that real photo scene, slightly out of focus. Medium close-up, vertical 9:16, single continuous shot, "
 "he stands facing the camera with a calm, friendly, confident expression like a news presenter, subtle natural head movements and blinks, "
 "hands relaxed, no pointing. "
