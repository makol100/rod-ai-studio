#!/bin/bash
# MONTAZ v6 — sklad: STARE frag_p1/p2/p6 (pion natywny prosty) + p3_v5 (transpose-fix WA0001) + p4_v3 + p5_v2
...
ffmpeg -y -v error \
 ...
 -noautorotate -i "$W/frag_p1.mp4" -noautorotate -i "$W/frag_p2.mp4" \
 -noautorotate -i "$W/frag_p3_v5.mp4" -noautorotate -i "$W/frag_p4_v3.mp4" \
