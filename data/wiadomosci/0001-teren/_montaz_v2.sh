...
ffmpeg -y -v error \
 -i "$W/stanislaw_0001_raw.mp4" \
 -i "$W/frag_p1_v2.mp4" -i "$W/frag_p2_v2.mp4" -i "$W/frag_p3.mp4" \
 -i "$W/frag_p4.mp4" -i "$W/frag_p5_v2.mp4" -i "$W/frag_p6_v2.mp4" \
 -i "$W/../WD_0001_teren_master.mp4" \
 -filter_complex "\
