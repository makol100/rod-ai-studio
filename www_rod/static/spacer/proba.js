...
var viewer = pannellum.viewer('panorama', {
  ...
  scenes: {
    parking: { title: 'Parking', type: 'equirectangular', panorama: '/static/spacer/parking.jpg',
      hotSpots: [{ pitch: -4, yaw: 118, type: 'scene', cssClass: 'strzalka', text: 'Plac zabaw', sceneId: 'plac', targetYaw: 95, targetPitch: 0 }] },
    plac:    { title: 'Plac zabaw', type: 'equirectangular', panorama: '/static/spacer/plac.jpg',
      hotSpots: [{ pitch: -4, yaw: 95, type: 'scene', cssClass: 'strzalka', text: 'Parking', sceneId: 'parking', targetYaw: 118, targetPitch: 0 }] }
  }
});
