...
## AKTUALIZACJA 27.07 wieczór — GŁOS GENKA (po włączeniu płatnego poziomu przez Tomasza)
Genek zaopiniował KOMPLET (pełny tekst: _genek_biblia2_out.txt): 1→A, 2→TAK, 3→A, 4→C, 5→TAK, 6→C, 7→TAK, 8→A, 9→C — PEŁNA ZGODNOŚĆ z Zenkiem i Klaudkiem.
Gotowe powiedzonka Genka (do kanonu pkt 2, jeśli Tomasz zatwierdzi):
- "Moi kochani, w przyrodzie nic nie ginie, tylko czasem zmienia właściciela, jak moja łopata w zeszłym roku"
...
- "U nas na ogrodzie polityki nie sadzimy, tu tylko spokój ma rosnąć" (pkt 5)
Wariant outra od Genka (alternatywa dla pkt 3): "No, herbatka już stygnie, to do następnego razu przy furtce!"
